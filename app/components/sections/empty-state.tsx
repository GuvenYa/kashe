...
export function EmptyState({
  ...
  return (
    <div className="flex flex-col items-center justify-center text-center py-20 px-6">
      ...
      <div className="w-20 h-20 rounded-2xl bg-brand-ink-08 flex items-center justify-center mb-6 text-brand-ink">
        {icon ?? (
      ...
      {actionLabel && actionHref && (
        <Link
          href={actionHref}
          className="kashe-tap inline-flex items-center gap-2 px-6 py-3 bg-brand-ink text-paper rounded-lg font-display font-semibold hover:bg-brand-ink-deep transition-colors"
        >
          {actionLabel}
        </Link>
      )}
