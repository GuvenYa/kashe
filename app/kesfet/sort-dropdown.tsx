  ...
  return (
    <label className="flex items-center gap-2">
      ...
      <select
        ...
        disabled={isPending}
        className="text-sm font-display text-ink bg-white border border-line rounded px-2 py-1.5 focus:outline-none focus:border-terracotta cursor-pointer disabled:opacity-50"
      >
        {OPTIONS.map((opt) => (
