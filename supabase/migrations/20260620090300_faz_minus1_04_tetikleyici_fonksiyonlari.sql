...
--
-- protect_sensitive_profile_fields GOVDE KAYNAGI (14 Eylul 2026: govde uretim
-- pg_get_functiondef ciktisiyla birebir esitlendi — yorum satirlari ve satir duzeni dahil;
-- bkz. docs/envanter/06-bos-db-zincir-testi.md bolum 6):
...
begin
  ...
  -- Normal kullanıcı: hassas alanlar eski değerinde kalır
